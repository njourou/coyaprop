...
<head>
    ...
    <title>Coya Properties - Properties</title> 
    
   <!-- Vendor CSS Files -->
    
    <link rel="icon" type="image/x-icon" href="assets/favicon.ico">
    <link rel="stylesheet" href="css/fonts.googleapis.com/cssf757.css?family=Montserrat:400,500,600,700">
                        ...
                        <div class="mdc-list"> 
                            <div> 
                                <a href="property.html" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Industrial</span> 
                                </a>  
                            </div><div> 
                                <a href="agents.html" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Residential</span> 
                                </a>  
                            </div>
                            <div> 
                                <a href="agent.html" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Commercial</span> 
                                </a>  
                            </div> 
                        </div>
                    </div>  
     ...
     height="70" />
                ...
                <div>
                    ...
                    <div class="mdc-menu-surface--anchor"> 
                        <a href="javascript:void(0);" class="mdc-button menu-item-has-children"> 
                            <span class="mdc-button__ripple"></span> 
                            <span class="mdc-button__label">Our Properties</span>
                        </a>  
                        <div class="mdc-menu mdc-menu-surface">
                            <div class="mdc-list"> 
                                <div> 
